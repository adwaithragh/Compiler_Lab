...
#line 1146 "y.tab.c"
  ...
  case 6: /* expr: NUM  */
#line 44 "ast.y"
                                  { (yyval.node) = make_leaf((yyvsp[0].num)); }
#line 1152 "y.tab.c"
    break;
...
#line 1176 "y.tab.c"
  ...
  case 11: /* expr: '-' expr  */
#line 49 "ast.y"
                                 { /* unary minus — represent with '~' (or choose another marker) */
                                    (yyval.node) = make_node('~', NULL, (yyvsp[0].node));
                                  }
#line 1184 "y.tab.c"
    break;
